...
def main() -> int:
    ...
    expected = {f"page-{i:03d}.md" for i in range(1, 47)}
    ...
    print(f"Checked {len(files)} page files (expected 001–046 present).")
    if extra_ok:
        print("Additional pages beyond 046:", ", ".join(sorted(extra_ok)))
    if errors:
        print("FAILED")
        for e in errors:
            print(" -", e)
