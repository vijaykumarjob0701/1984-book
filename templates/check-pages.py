...
def main() -> int:
    ...
    expected = {f"page-{i:03d}.md" for i in range(1, 136)}
    ...
    print(f"Checked {len(files)} page files (expected 001–135 present).")
    if extra_ok:
        print("Additional pages beyond 135:", ", ".join(sorted(extra_ok)))
    if errors:
        print("FAILED")
        for e in errors:
            print(" -", e)
